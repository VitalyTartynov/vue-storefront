...
import { Filter, FilterOption } from '@vue-storefront/virtocommerce-api/lib/types/Api';
import { Attribute } from '@vue-storefront/virtocommerce-api/lib/types/GraphQL';
