...
import { ProductVariant, Attribute } from '@vue-storefront/virtocommerce-api/lib/types/GraphQL';

describe('[virtocommerce-composables] getFiltersFromProductsAttributes', () => {
