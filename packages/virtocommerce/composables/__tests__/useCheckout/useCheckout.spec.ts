...
jest.mock('@vue-storefront/virtocommerce-api', () => ({
...
import { updateCart, getShippingMethods, createMyOrderFromCart, createCart } from '@vue-storefront/virtocommerce-api';
import initFields from './../../src/useCheckout/initFields';

describe('[virtocommerce-composables] useCheckout/setShippingDetails', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/setBillingDetails', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/loadDetails', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/loadPaymentMethods', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/loadShippingMethods', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/placeOrder', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/setPaymentMethod', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/setPersonalDetails', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/setShippingMethod', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
...
describe('[virtocommerce-composables] useCheckout/initFields', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    resetFields();
  });
