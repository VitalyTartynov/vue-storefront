...
import { mapConfigToSetupObject, CT_TOKEN_COOKIE_NAME } from '@vue-storefront/virtocommerce/nuxt/helpers'

const moduleOptions = JSON.parse('<%= JSON.stringify(options) %>');

<% if (!options.disableGenerateTokenMiddleware) { %>
import Middleware from './middleware'
import ctTokenMiddleware from '@vue-storefront/virtocommerce/nuxt/token-middleware'
import { CT_TOKEN_MIDDLEWARE_SLUG } from '@vue-storefront/virtocommerce/nuxt/helpers'
